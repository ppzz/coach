...
public class AddTest {
    ...
    public void should_get_sum_of_evens(){
        ...
        Add add = new Add();
        assertThat(add.getSumOfEvens(leftBorder, rightBorder), is(30));
        assertThat(add.getSumOfEvens(rightBorder, leftBorder), is(30));
    }
    ...
    public void should_get_sum_of_odds(){
        ...
        Add add = new Add();
        assertThat(add.getSumOfOdds(leftBorder, rightBorder), is(25));
        assertThat(add.getSumOfOdds(rightBorder, leftBorder), is(25));
    }
    ...
    public void should_map_median_to_letter(){
        ...
        assertThat(add.mapMedianToLetter(left, right), is("j"));
    }
    ...
    public void should_get_triple_and_add_two(){
        ...
        assertThat(add.getSumTripleAndAddTwo(arrayList), is(390));
    }
    ...
    public void should_get_triple_of_odd_and_add_two(){
        ...
        assertThat(add.getTripleOfOddAndAddTwo(arrayList), is(resultList));
    }
    ...
    public void should_get_sum_of_processed_odd(){
        ...
        assertThat(add.getSumOfProcessedOdds(arrayList), is(408));
    }
    ...
    public void should_map_even_to_letter(){
        ...
        Add add = new Add();
        assertThat(add.mapEvenToLetter(arrayList), is(resultObject));
    }
    ...
    public void should_map_average_to_letter(){
        ...
        assertThat(add.mapAverageToLetter(arrayList), is("e"));
    }
    ...
    public void should_process_elements(){
        ...
        assertThat(add.getProcessedList(arrayList), is(resultList));
    }
    ...
    public void should_return_median_of_even_index(){
        ...
        Add add = new Add();
        assertThat(add.getMedianOfEvenIndex(arrayList), is((double) 3));
    }
    ...
    public void should_return_average_of_even_index(){
        ...
        Add add = new Add();
        assertThat(add.getAverageOfEvenIndex(arrayList), is((double) 3));
    }
    ...
    public void should_return_whether_include_special_element(){
        ...
        assertThat(add.isIncludedInEvenIndex(arrayList, existedElment), is(true));

        Integer unexistedElment = 2;
        assertThat(add.isIncludedInEvenIndex(arrayList, unexistedElment), is(false));
    }
    ...
    public void should_return_unrepeated_elements_from_evens(){
        ...
        Add add = new Add();
        assertThat(add.getUnrepeatedFromEvenIndex(arrayList), is(resultList));
    }
    ...
    public void should_divide_evens(){
        ...
        assertThat(add.mapEvens(arrayList).get(1), is(2));
        assertThat(add.mapEvens(arrayList).get(2), is(3));
        assertThat(add.mapEvens(arrayList).get(3), is(1));
    }
    ...
    public void should_sort_by_two_big_followed_one_small(){
        ...
        assertThat(add.sortByTwoBigOneSmall(firstArrayList), is(firstResultList));
        ...
        assertThat(add.sortByTwoBigOneSmall(secondArrayList), is(secondResultList));
    }
    ...
    public void should_sort_by_even_and_odd(){
        ...
        assertThat(add.sortByEvenAndOdd(arrayList), is(resultList));
    }
}
